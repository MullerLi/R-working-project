# Package names
packages <- c("ggplot2","tidyverse","carData","magrittr" , "dplyr", "tidyr", "reshape2", "agricolae","car", "multcomp",  "rcompanion", "openxlsx", "ggpubr", "carData", "magrittr","corrplot","datarium","rstatix", "FSA", "dslabs", "magrittr", "tidyverse")
